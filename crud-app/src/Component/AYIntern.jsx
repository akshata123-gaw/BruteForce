...
const AYIntern = () => {
    ...
    return (
         ...
         <div style={{ 
            ...
            <Box color="black" 
                bgcolor="rgb(255,253,208)" p={8} alignItems={'center'} >
                    <Button color="primary" variant="contained" style={{padding:"10px"}}component={Link} to="/addappo/aallint">Internships</Button>
            </Box>
        </div>
        ...
        <div style={{ 
            ...
            <Box color="black" 
                bgcolor="rgb(255,253,208)" p={8} alignItems={'center'} >
                    <Button color="primary" variant="contained" style={{padding:"10px"}}component={Link} to="/addappo/aallppo">Full Time PPO</Button>
            </Box>
        </div>
